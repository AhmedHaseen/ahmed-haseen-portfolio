  ...
  return (
    <div className={dark ? "dark" : ""}>
      ...
      <a
        ...
        className="group md:hidden fixed bottom-6 right-6 z-50"
      >
        ...
        <span className="w-12 h-12 rounded-full bg-[#25D366] shadow-lg shadow-black/10 flex items-center justify-center animate-pulse">
